...
"NA,can,box,small,medium,large,stick,pinch,dash,tbsp - tablespoon,tsp - teaspoons,cup,fl oz - fluid ounces,pt - pint,qt - quart,gal - gallon,oz - ounces,lb - pound,in - inch,L - litre,ml - milliliter,g - grams,kg - kilogram,cm - centimeter".split(',').each do |u|
